...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-lg-4 p-2 bill">
                        ...
                        <div class="col-12">
                            ...
                            <p>
                                <button onclick="createInvoice()"
                                    class="btn bg-info text-light text-bold my-3 w-40">Confirm</button>
                            </p>
                        </div>
            ...
            <div class="col-md-4 col-lg-4 p-2">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    <a href="/productPage"> <button id="save-btn" class="btn bg-info text-light text-bold">Add New
                            Product</button></a>
            ...
            <div class="col-md-4 col-lg-4 p-2">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    <a href="/customerPage"> <button id="save-btn" class="btn bg-info text-light text-bold">Add New
                            Customer</button></a>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 p-1">
                                    ...
                                    <label class="form-label mt-2">Product Avaiable *</label>
                ...
                <div class="modal-footer">
                    <button id="modal-close" class="btn bg-info mx-2 text-light text-bold" data-bs-dismiss="modal"
    ...
    <script>
        ...
        function ShowInvoiceItem() {
            ...
            InvoiceItemList.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-index="${index}" class="btn bg-info remove text-xxs text-bold text-light px-2 py-1  btn-sm m-0">Remove</a></td>
                     </tr>`
        ...
        function add() {
            ...
            } else if (parseFloat(PQty) > parseFloat(PUnit)) {
                errorToast("Product Quantity Not Available");
            } else {
                let existingItem = InvoiceItemList.find(item => item.product_id === PId);
                if (existingItem) {
                    // If the product already exists in the list, update the quantity and total price
                    existingItem.qty = (parseFloat(existingItem.qty) + parseFloat(PQty));
                    existingItem.sale_price = (parseFloat(existingItem.sale_price) + parseFloat(PTotalPrice));
                } else {
        ...
        async function CustomerList() {
            ...
            res.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-email="${item['email']}" data-id="${item['id']}" class="btn bg-info text-light text-bold addCustomer text-xxs px-2 py-1  btn-sm m-0">Add</a></td>
                     </tr>`
        ...
        async function ProductList() {
            ...
            res.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-price="${item['price']}" data-unit="${item['unit']}" data-id="${item['id']}" class="btn bg-info text-bold text-light text-xxs px-2 py-1 addProduct btn-sm m-0">Add</a></td>
                     </tr>`
